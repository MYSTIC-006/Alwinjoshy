...
function downloadCV() {
  ...
  link.href = 'assests/ALWIN JOSHY (3).pdf'; // Replace with the actual path to your CV file
  link.download = 'ALWIN JOSHY CV.pdf'; // The name of the file to be downloaded
